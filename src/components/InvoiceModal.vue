              ...
              <div class="work-items">
                  ...
                  <table class="item-list">
                      ...
                      <tr class="table-items flex" v-for="(item, index) in invoiceItemList" :key="index">
                          <td class="input item-name"><input type="text" v-model="item.itemName" /></td>
                          <td class="input qty"><input type="text" v-model="item.qty" /></td>
                          <td class="input price"><input type="text" v-model="item.price" /></td>
                          <td class="input total">${{ (item.total = item.qty*item.price) }}</td>
...
export default {
    ...
    created() {
        ...
        if(!this.editInvoice) {
            ...
            this.invoiceDate = new Date(this.invoiceDateUnix).toLocaleDateString('it-it', this.dateOptions)
        }
        if(this.editInvoice) {
    ...
    watch: {
        paymentTerms() {
            ...
            this.paymentDueDate = new Date(this.paymentDueDateUnix).toLocaleDateString("it-it", this.dateOptions);
        }
    }
}
</script>
...
.invoice-wrap {
    ...
    .invoice-content {
        ...
        color: white;
        box-shadow: 10px 4px 6px -1px rgba(0,0,0,0.2), 2px 4px 4px -1px rgba(0,0,0,0.06);

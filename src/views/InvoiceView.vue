  ...
  <div v-if="currentInvoice" class="invoice-view container">
    ...
    <div class="header flex">
      ...
      <div class="right flex">
        ...
        <button class="green" @click="updateStatusToPaid(currentInvoice.docId)" v-if="currentInvoice.invoicePending">Mark as Paid</button>
        <button class="orange" @click="updateStatusToPending(currentInvoice.docId)" v-if="currentInvoice.invoiceDraft || currentInvoice.invoicePaid">Mark as Pending</button>
      </div>
    </div>
    <!-- Details -->
